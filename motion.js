...
(() => {
  ...
  const runCounts = (slide, gen) => {
    slide.querySelectorAll('[data-count]').forEach((el) => {
      ...
      // data-count-dp: decimal places to hold while counting. Without it a
      // figure like 92.5 would tick through whole numbers and land on "93".
      const dp = parseInt(el.dataset.countDp || '0', 10);
      const fmt = (v) => v.toFixed(dp) + suffix;
